...
public class DestroyGreenCrystal : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.transform.tag == "PlayerGreen")
            {
            ...
            else if (other.gameObject.transform.tag == "PlayerRed" || other.gameObject.transform.tag == "PlayerBlue")
            {
