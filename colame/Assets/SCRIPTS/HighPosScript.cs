...
public class HighPosScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (PointsManager.instance.FINISHsTATES == 1 && FlagGoONce == 0)
        {
            ...
            noOfDiamonds = PointsManager.instance.highestScore;              ////simple modification in no of diamonds
            ...
            for (int i = 0; i < SpeedStringLength; i++)
            {
                ...
                TextObjectInstantiated.transform.position += new Vector3(a * i, 0, 0);     /////simple modification in no of diamonds
